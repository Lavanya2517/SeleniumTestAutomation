...
{
	@Test
	public void HomePage_verification() throws Throwable
	{
		Credentials.url=CommonFunctions.readPropertiesFile("SanityTestHomePage");
...
//		Scenario1Test.homePageObj.addCementProductToCart();		
//		/* ========= Verify the item added success msg ======= */
//		//Assert.assertEquals(Scenario1Test.homePageObj.validateSuccessMsgInShoppingList(), "Crabtree Athena RJ-11 One Gang with shutter was added to your shopping list.");		
//		/* =============== Verify the count of cart items ======== */
